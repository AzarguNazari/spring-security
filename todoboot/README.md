...
1. You can run application
    1. `com.springboot.exercise.Application class` or
    ...
    ```
2. [Go-to main page](http://localhost:9999/home) you will be redirected login page
    1. Click registration tab and register with any usermane and password [Go-to register page](http://localhost:9999/register) 
3. Login with your username and password [Go-to login page](http://localhost:9999/login) 
